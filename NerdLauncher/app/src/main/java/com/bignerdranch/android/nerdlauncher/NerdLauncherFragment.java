...
public class NerdLauncherFragment extends Fragment {
    ...
    private class ActivityHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ActivityHolder(View itemView){
            super(itemView);
            mImageView = (ImageView)itemView.findViewById(R.id.image_of_aplication);
            mNameTextView = (TextView) itemView.findViewById(R.id.name_of_aplication);
    ...
    private class ActivityAdapter extends RecyclerView.Adapter<ActivityHolder>{
        ...
        public ActivityHolder onCreateViewHolder(ViewGroup parent, int viewType){
            ...
            View view = layoutInflater.inflate(R.layout.frame_layout_item, parent, false);
